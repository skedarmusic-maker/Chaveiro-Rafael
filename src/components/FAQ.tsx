...
const questions = [
    ...
    {
        question: "Atendem em quais bairros de Ribeirão Preto?",
        answer: "Atendemos Ribeirão Preto e região. Nossa equipe móvel vai até você onde estiver precisando de assistência."
    },
    {
                ...
                <div className="space-y-4">
                    {questions.map((q, i) => (
                        ...
                        >
                            ...
                            >
                                <span className="font-medium text-lg text-slate-800">{q.question}</span>
                                <span className={`text-primary-600 transform transition-transform duration-300 ${openIndex === i ? 'rotate-180' : ''}`}>
